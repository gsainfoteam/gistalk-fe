        ...
        oneLineReview: [
            {
                ...
                like: 1212,
                dislike: 10,
                content: ['여름학기를 즐길 생각이라면 로드가 많아서 비추천, 하지만 수업 자체로 놓고 본다면 지스트에서 하는 것보다 환경이 잘 정리되어 있고 신기술 adoption이 빨라 많은 도움이 됨'],
                pushedLike: 'none',
                isLocked:false
            },
            {
            ...
            },
            {
                ...
                like: 5,
                dislike: 77,
                content: ['진짜 가슴이 웅장해진다... 강의 실화냐?? 정말 세계관 최강자의 강의이다...'],
                pushedLike: 'dislike',
                isLocked:false
            },
        ...
        detailedReview: [
            {
                ...
                like: 1212,
                dislike: 898,
                content: ['모두 객관식으로 나옵니다. OX퀴즈도 포함되는데 OX퀴즈는 틀리면 오히려 점수가 깎이는 특이한 메커니즘을 가지고 있습니다. 그니까 확실하지 않으면 OX퀴즈에서는 그냥 답 표시 안하는게 이득임.',
            ...
            },
            {
                ...
                like: 512,
                dislike: 10,
                content: ['Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus metus arcu, sollicitudin sit amet tempor id, fringilla at leo. Sed sodales mi libero. Mauris metus ex, condimentum at orci in, volutpat varius sapien. .',
