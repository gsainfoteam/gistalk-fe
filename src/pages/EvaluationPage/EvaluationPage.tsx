...
export function EvaluationPage() {
  ...
  const isEvaluationEmpty = //선택한 강의의 데이터 유무를 보여줌
    selectedEvaluation.every((value) => value !== undefined) &&
    selectedEvaluation[clickedId] !== undefined &&
    Object.values(selectedEvaluation[clickedId]).every(
      (value) => value === null
    );
          ...
          >
            ...
            {!evaluationLoading &&
              (selectedId.every((value) => value === null) ? ( //아무런 교수도 선택하지 않았을 때
                ...
                <span> 이 강의에 {ReviewAmount()}명이 평가를 남겼어요</span>
              ))}
          </OneLineReviewText>
